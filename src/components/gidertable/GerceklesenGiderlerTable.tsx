...
interface GerceklesenGiderlerTableProps {
  giderler: Gider[];
  currentPage: number;
  itemsPerPage: number;
...
export default function GerceklesenGiderlerTable({ 
  giderler, 
  currentPage, 
  itemsPerPage, 
  onPageChange 
}: GerceklesenGiderlerTableProps) {
        ...
        <div className="overflow-hidden">
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead>
                <tr className="bg-gradient-to-r from-green-50 to-emerald-100/50">
                  ...
                  <td colSpan={6} className="px-6 py-16 text-center">
                    <div className="flex flex-col items-center justify-center space-y-4">
                      ...
                      <div className="text-center">
                        <h3 className="text-lg font-medium text-gray-900 mb-1">Henüz gerçekleşen gider yok</h3>
                        <p className="text-gray-500">Ödenen gider bulunmuyor.</p>
                      </div>
                    </div>
                  </td>
                </tr>
  ...
  return (
    <div className="bg-white/50 backdrop-blur-sm border border-white/20 rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-green-50/60 to-emerald-100/60 backdrop-blur-sm px-6 py-4 border-t border-gray-200/50">
