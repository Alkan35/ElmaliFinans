...
interface TumGiderlerTableProps {
  giderler: Gider[];
  currentPage: number;
  itemsPerPage: number;
...
export default function TumGiderlerTable({ 
  giderler, 
  currentPage, 
  itemsPerPage, 
  onPageChange 
}: TumGiderlerTableProps) {
  ...
  const getStatusColor = (odendi: boolean, durum?: string) => {
    if (odendi === true || durum === 'gerceklesen') {
                  ...
                  <td colSpan={7} className="px-6 py-16 text-center">
                    <div className="flex flex-col items-center justify-center space-y-4">
                      ...
                      <div className="text-center">
                        <h3 className="text-lg font-medium text-gray-900 mb-1">Henüz gider kaydı yok</h3>
                        <p className="text-gray-500">Bu kategoride gösterilecek gider bulunmuyor.</p>
                      </div>
                    </div>
                  </td>
                </tr>
  ...
  return (
    <>
      <div className="bg-white/50 backdrop-blur-sm border border-white/20 rounded-2xl shadow-lg overflow-hidden">
              ...
              <tbody className="bg-white/30 backdrop-blur-sm divide-y divide-gray-200/50">
                {paginatedGiderler.map((gider, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {gider.odemeTarihi ? formatDate(gider.odemeTarihi) : '-'}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                        getStatusColor(gider.odendi || false, gider.durum)
                      }`}>
                        <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        {gider.odendi === true || gider.durum === 'gerceklesen' ? 'Ödendi' : 'Ödenmesi Gereken'}
                      </span>
                    </td>
                  </tr>
                ))}
        ...
        <div className="bg-white/40 backdrop-blur-sm px-6 py-4 border-t border-gray-200/50">
