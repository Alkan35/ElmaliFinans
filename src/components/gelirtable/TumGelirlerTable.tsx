...
interface TumGelirlerTableProps {
  gelirler: Gelir[];
  currentPage: number;
  itemsPerPage: number;
...
export default function TumGelirlerTable({ 
  gelirler, 
  currentPage, 
  itemsPerPage, 
  onPageChange 
}: TumGelirlerTableProps) {
                  ...
                  <td colSpan={6} className="px-6 py-16 text-center">
                    <div className="flex flex-col items-center justify-center space-y-4">
                      ...
                      <div className="text-center">
                        <h3 className="text-lg font-medium text-gray-900 mb-1">Henüz gelir kaydı yok</h3>
                  ...
                  <tr key={gelir.id} className="group hover:bg-blue-50/30 transition-all duration-200 border-b border-gray-100/50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(gelir.durum)} ring-1 ring-inset ring-gray-200`}>
                        ...
                        {gelir.durum === 'tahsilEdildi' ? 'Tahsil Edildi' : 
                         gelir.durum === 'kesinlesen' ? 'Kesinleşen' : 'Bekleniyor'}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
